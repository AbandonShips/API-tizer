...
const S = {
  ko: {
    ...
    'top.share': '🔗 공유',
    'top.share_title': '이 대화를 읽기 전용 링크로 공유 (7일 후 자동 만료 · 영지식 암호화)',
    ...
    'set.timeout': '타임아웃 (초)',
    'set.timeout_tip': '일정 시간 아무 신호도 없으면 타임아웃으로 처리합니다 (답이 오는 중에는 계속 리셋). (기본 120초, 0=사용 안 함)',
    ...
    'help.f_timeout_html': '<b>⏱️ 타임아웃</b> — 한 모델이 일정 시간 아무 신호도 안 주면(답하는 중에는 계속 리셋, 기본 120초) 기다리지 않고 넘어갑니다. 마스터가 실패하면 다른 완료된 모델에게 요약을 대신 맡길 수 있습니다.',
    ...
    'ext.billing_grok': 'xAI 팀 크레딧이 소진되었거나 월 지출 한도에 도달했습니다 (API 키 문제가 아닙니다). https://console.x.ai/ 에서 크레딧을 충전하거나 지출 한도를 올리세요.',
    'ext.billing_generic': '결제/크레딧 문제로 보입니다. 해당 제공자의 콘솔에서 결제 상태와 한도를 확인하세요.',
    ...
    'confirm.reset_all': "{who} 데이터를 정말 초기화할까요? (채팅 {count}개 포함)\n\n· 저장된 API 키와 설정\n· 모든 채팅 기록\n\n영구 삭제되며 되돌릴 수 없습니다. (계정은 유지됩니다)",
    'confirm.reset_chats': "{who}의 대화내용만 모두 삭제할까요? (현재 {count}개)\n\n· 채팅방과 질문/답변 기록 삭제\n· API 키, 모델 설정, 개인 맞춤, 사용량은 유지\n\n되돌릴 수 없습니다.",
    ...
    'server.share_too_large': '공유할 대화가 너무 큽니다.',
    'server.share_not_found': '공유 링크를 찾을 수 없습니다.',
    'server.share_expired': '만료된 공유 링크입니다.',

    // ---- Share: create modal ----
    'share.title': '읽기 전용 링크로 공유',
    'share.desc': '이 대화의 현재 내용을 링크로 공유합니다. 링크를 가진 사람은 로그인 없이 이 대화만 볼 수 있어요. 복호화 키는 링크 안에만 있고, 서버에는 암호문만 저장됩니다(영지식).',
    'share.snapshot_note': '📸 지금 이 순간의 스냅샷입니다. 이후 대화를 더 이어가도 이 링크의 내용은 바뀌지 않아요.',
    'share.expiry_note': '⏱ 링크는 7일 후 자동으로 만료됩니다.',
    'share.include_images': '첨부 이미지 포함',
    'share.include_images_hint': '기본은 텍스트만 공유합니다. 켜면 이미지를 압축해 함께 담습니다(용량 증가).',
    'share.create': '링크 만들기',
    'share.creating': '만드는 중…',
    'share.copy': '복사',
    'share.copied': '복사됨!',
    'share.ready': '링크가 준비됐습니다. 복사해서 공유하세요.',
    'share.expires_on': '만료: {date}',
    'share.err_too_large_images': '이미지까지 담기엔 용량이 너무 큽니다. 텍스트만 공유할까요?',
    'share.retry_text_only': '텍스트만 다시 만들기',
    'share.err_too_large': '대화가 너무 커서 공유할 수 없습니다. 더 짧은 구간을 공유하거나 대화를 압축한 뒤 다시 시도하세요.',
    'share.err_generic': '공유 링크를 만들지 못했습니다: {err}',
    'share.need_online': '공유하려면 온라인 계정으로 로그인해야 합니다. (이 기기 저장 모드에서는 사용할 수 없어요)',
    'share.empty': '공유할 대화 내용이 없습니다.',
    'share.imported': '공유된 대화를 내 보관함에 가져왔습니다.',

    // ---- Share: read-only viewer ----
    'view.badge': '읽기 전용 · 공유된 대화',
    'view.banner': '공유된 대화의 읽기 전용 스냅샷입니다. 원본 작성자가 이후 나눈 대화는 포함되지 않습니다.',
    'view.copy': '⧉ 복사',
    'view.import': '내 계정으로 가져오기',
    'view.open_app': 'API-Tizer 열기',
    'view.copied': '대화가 클립보드에 복사되었습니다.',
    'view.loading': '공유된 대화를 불러오는 중…',
    'view.shared_on': '공유일: {date}',
    'view.master_label': '👑 마스터 요약',
    'view.crosscheck_label': '🔍 교차검증',
    'view.image_omitted': '🖼 (이미지 생략됨)',
    'view.err_invalid': '잘못된 공유 링크이거나 링크가 손상되었습니다.',
    'view.err_not_found': '공유 링크를 찾을 수 없습니다. 삭제되었거나 만료되었을 수 있습니다.',
    'view.err_expired': '이 공유 링크는 만료되었습니다(7일 경과).',
    'view.err_endpoint': '허용되지 않은 공유 서버 주소입니다.',
    'view.err_offline': '공유 서버에 연결할 수 없습니다. 잠시 후 다시 시도하세요.',
    'view.err_generic': '공유된 대화를 불러오지 못했습니다.',
  ...
  en: {
    ...
    'top.share': '🔗 Share',
    'top.share_title': 'Share this chat as a read-only link (auto-expires in 7 days · zero-knowledge encrypted)',
    ...
    'set.timeout_tip': "If there is no signal for the given time (sec), it is treated as a timeout (keeps resetting while a response is streaming). (Default 120s, 0 = disabled)",
    ...
    'help.f_timeout_html': "<b>⏱️ Timeout</b> — If a model goes silent for the set time (keeps resetting while it streams, default 120s), it moves on without waiting. If the master fails, another finished model can write the summary instead.",
    ...
    'ext.billing_grok': 'Your xAI team has used all available credits or reached its monthly spending limit (not an API key problem). Top up credits or raise the spending limit at https://console.x.ai/.',
    'ext.billing_generic': 'This looks like a billing/credit problem. Check the payment status and limits in that provider\'s console.',
    ...
    'server.share_too_large': 'The shared conversation is too large.',
    'server.share_not_found': 'This shared link was not found.',
    'server.share_expired': 'This shared link has expired.',

    // ---- Share: create modal ----
    'share.title': 'Share as a read-only link',
    'share.desc': 'Share this chat as a link. Anyone with the link can view just this conversation, no login required. The decryption key lives only in the link — the server stores ciphertext only (zero-knowledge).',
    'share.snapshot_note': '📸 This is a snapshot of right now. If you keep chatting, this link will NOT change.',
    'share.expiry_note': '⏱ The link automatically expires after 7 days.',
    'share.include_images': 'Include attached images',
    'share.include_images_hint': 'Text only by default. When on, images are compressed and bundled in (larger link).',
    'share.create': 'Create link',
    'share.creating': 'Creating…',
    'share.copy': 'Copy',
    'share.copied': 'Copied!',
    'share.ready': 'Your link is ready. Copy it to share.',
    'share.expires_on': 'Expires: {date}',
    'share.err_too_large_images': 'Too large to include images. Share text only?',
    'share.retry_text_only': 'Recreate text-only',
    'share.err_too_large': 'This conversation is too large to share. Share a shorter section or compact it first, then try again.',
    'share.err_generic': 'Could not create the share link: {err}',
    'share.need_online': 'Sharing requires an online account. (Not available in this-device-only mode.)',
    'share.empty': 'There is nothing to share yet.',
    'share.imported': 'Imported the shared conversation into your library.',

    // ---- Share: read-only viewer ----
    'view.badge': 'Read-only · shared conversation',
    'view.banner': 'This is a read-only snapshot of a shared conversation. Anything the author said afterwards is not included.',
    'view.copy': '⧉ Copy',
    'view.import': 'Import to my account',
    'view.open_app': 'Open API-Tizer',
    'view.copied': 'Conversation copied to clipboard.',
    'view.loading': 'Loading the shared conversation…',
    'view.shared_on': 'Shared: {date}',
    'view.master_label': '👑 Master summary',
    'view.crosscheck_label': '🔍 Cross-check',
    'view.image_omitted': '🖼 (image omitted)',
    'view.err_invalid': 'This share link is invalid or corrupted.',
    'view.err_not_found': 'This shared link was not found. It may have been deleted or expired.',
    'view.err_expired': 'This shared link has expired (older than 7 days).',
    'view.err_endpoint': 'This share server address is not allowed.',
    'view.err_offline': 'Could not reach the share server. Please try again shortly.',
    'view.err_generic': 'Could not load the shared conversation.',
